<template>
  <div class="login-wrap" align="center">
    <el-form :model="admin" :rules="rules" ref="ruleForm" style="width: 20%;">
      <h3 class="title">用户登录</h3>
      <el-form-item prop="name">
        <el-input type="text" v-model="admin.name" auto-complete="off" placeholder="账号"></el-input>
      </el-form-item>
...
<script type="text/ecmascript-6">
  ...
  import {error,error_common, success} from "../utils/message";
